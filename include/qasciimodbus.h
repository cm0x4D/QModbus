...
#   endif
  ...
  public:
    ...
    */
    bool open(const QString& device, BaudRate baudRate = BR9600, BitsPerCharacter bitPerCharacter = BPC7,
              StopBits stopBits = OneStopbit, Parity parity = NoParity, FlowControl flowControl = NoFlowControl);
    ...
    */
    ...
    QList<bool> readCoils(quint8 deviceAddress, quint16 startingAddress, quint16 quantityOfCoils,
                          quint8* const quint8 = NULL) const;
    ...
    QList<quint16> writeReadMultipleRegisters(quint8 deviceAddress, quint16 writeStartingAddress,
                                               ...
                                               quint16 quantityToRead, quint8* const quint8 = NULL) const;
    QList<quint16> readFifoQueue(quint8 deviceAddress, quint16 fifoPointerAddress, quint8* const quint8 = NULL) const;
...
#   ifdef Q_OS_WIN
        QByteArray _read(int numberBytes) const;
        QByteArray _readAll() const;
        QByteArray _readLine(int maxBytes) const;
        bool _write(const QByteArray& data) const;
#   endif
