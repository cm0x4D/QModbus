...
#   endif
  ...
  public:
    ...
    */
    bool open(const QString& device, BaudRate baudRate = BR9600, StopBits stopBits = OneStopbit,
              Parity parity = NoParity, FlowControl flowControl = NoFlowControl,
              RtsDriveMode rtsDriveMode = RtsNotDriven );
